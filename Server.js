...
const prfCooRoutes = require("./routes/prfCooRoutes")
const prfCheckedByRoutes = require("./routes/prfCheckedByRoutes")
// IMPORTANT for IIS
...
app.use("/api", prfCooRoutes)
app.use("/api", prfCheckedByRoutes)
