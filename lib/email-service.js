        ...
        <div style="background: white; padding: 30px 20px; border-radius: 0 0 5px 5px;">
          ...
          <div style="background: #FFF3E0; border-left: 5px solid #FF6B35; padding: 20px; margin: 25px 0; border-radius: 4px;">
            ...
            <table style="width: 100%; border-collapse: collapse; margin-top: 10px;">
              <tr style="border-bottom: 1px solid #FFE0B2;">
                ...
                <td style="padding: 10px 0; color: #FF6B35; font-weight: bold; font-size: 16px;">${prfData.prfNo}</td>
              </tr>
              <tr style="border-bottom: 1px solid #FFE0B2;">
              ...
              <tr style="border-bottom: 1px solid #FFE0B2;">
                <td style="padding: 10px 0; color: #666; font-weight: 600;">Prepared By:</td>
                <td style="padding: 10px 0; color: #333;">${prfData.preparedBy}</td>
              </tr>
              <tr>
                <td style="padding: 10px 0; color: #666; font-weight: 600;">Company:</td>
                <td style="padding: 10px 0; color: #333;">${prfData.company}</td>
              </tr>
            </table>
          </div>

          <!-- Action Required Section -->
          <div style="background: #F5F5F5; border: 2px solid #FF6B35; padding: 20px; margin: 25px 0; border-radius: 4px;">
            <p style="margin: 0 0 15px 0; font-weight: bold; color: #D32F2F; font-size: 16px;">Action Required:</p>
            <ul style="margin: 0; padding-left: 20px; color: #555;">
              <li style="margin-bottom: 10px;">Check if stock code <strong>${prfData.stockCode}</strong> (${prfData.stockName}) is available in inventory</li>
              <li style="margin-bottom: 10px;">Confirm stock quantity and status</li>
              <li style="margin-bottom: 10px;">Once verified, the PRF will proceed to the approval chain</li>
            </ul>
          </div>
          ...
          <div style="background: #E8F5E9; border-left: 4px solid #4CAF50; padding: 15px; margin: 25px 0; border-radius: 4px;">
            <p style="margin: 0; color: #2E7D32; font-size: 14px;">
              <strong>Process Status:</strong> Awaiting Stock Availability Confirmation → Checked By → Approved By → Received By
            </p>
          </div>

          <!-- Footer -->
          <p style="color: #888; font-size: 13px; margin-top: 30px; padding-top: 20px; border-top: 1px solid #e0e0e0;">
            <br>
            <strong>Best regards,</strong><br>
            ${prfData.company} Purchase Requisition System
          </p>
